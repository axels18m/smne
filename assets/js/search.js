...
var doctors = [
  {
    ...
    congress: [
      ...
      {
        topic:
          "Abordaje etiológico de la obesidad, claves para definir el tratamiento ideal  para mi paciente.",
        from: "",
        to: "",
        duration: "",
      },
    ...
    address: {
      completeAddress:
        "Hospital Zambrano Helion, Batallon de San Patricio #112",
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Manejo del hiperandrogenismo en el Síndrome de Ovario Poliquístico",
        from: "17:30",
        to: "18:10",
        duration: "40 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/ana-eugenia-teniente-sanchez/endocrinologo-internista/nuevo-leon",
    },
  },
  {
    id: 18,
    ...
    congress: [
      {
        topic:
          "Aspectos para el diagnóstico de Síndrome de Ovario Poliquístico",
        from: "16:00",
        to: "16:40",
        duration: "40 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/jose-armando-quintanilla-siller/endocrinologo-internista/nuevo-leon",
    },
  },
  {
    id: 19,
    ...
    congress: [
      {
        topic:
          "Resistencia a la insulina, marcadores sensibles en el Síndrome de Ovario poliquístico",
        from: "16:40",
        to: "17:20",
        duration: "40 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/marco-antonio-guerra-torres-2/endocrinologo-internista/ciudad-acuna",
    },
  },
  {
    id: 80,
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Nutrición y suplementación en el Síndrome de Ovario Poliquístico",
        from: "18:10",
        to: "18:50",
        duration: "40 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/estefania-de-fatima-esparza-corona/nutriologo-clinico/nuevo-leon",
    },
  },
  {
    id: 22,
    ...
    congress: [
      {
        topic:
          "Calculando y decidiendo tratamiento conforme el Riesgo Cardiovascular en mi pacientes con Diabetes tipo 2:Casos clínicos",
        from: "16:00",
        to: "16:30",
        duration: "30 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/elizabeth-olavide-aguilar/endocrinologo-internista/monterrey",
    },
  },
  {
    id: 1,
    ...
    address: {
      completeAddress:
        "Miguel Hidalgo 2532 (Esquina Calle Muguerza ), Monterrey",
      suburb: "Obispado",
      state: "Nuevo León",
      town: "Monterrey",
      zipcode: "64060",
    ...
    socialMedia: {
      ...
      website:
        "https://www.doctoralia.com.mx/dania-lizet-quintanilla-flores/endocrinologo-internista/nuevo-leon?fbclid=IwAR0rst9m20pqxgbyQirDWteO0daJJsWZ-KYb-v0LZsrJFCw8kCSxk7rnnJI",
    },
  },
  {
    id: 2,
    ...
    address: {
      completeAddress:
        "Avenida Nexxus 104 Parque industria Nexxus Planta Baja,",
      suburb: "Miravalle",
      state: "Nuevo León",
      town: "Monterrey",
      zipcode: "64718",
    ...
    socialMedia: {
      linkedin:
        "https://www.linkedin.com/in/arnulfo-gonz%C3%A1lez-cant%C3%BA-611a8863/?originalSubdomain=mx",
    },
  },
  {
    id: 3,
    ...
    socialMedia: {
      linkedin:
        "https://www.linkedin.com/in/anabel-rodr%C3%ADguez-romo-167aaa63/?originalSubdomain=mx",
    },
  },
  {
    id: 4,
  ...
  },
  {
    ...
    socialMedia: {
      linkedin:
        "https://www.linkedin.com/in/juan-jos%C3%A9-medina-jasso-315426112/?originalSubdomain=mx",
    },
  },
  {
    id: 8,
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/david-sanchez-garcia/endocrinologo/monterrey",
    },
  },
  {
    id: 9,
    ...
    socialMedia: {
      ...
      doctoralia:
        "https://www.doctoralia.com.mx/marco-antonio-roman-montalvo/endocrinologo-internista/nuevo-leon",
    },
  },

  {
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/celina-salas-castro/ginecologo/san-pedro-garza-garcia",
    },
  },
  {
    id: 12,
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Fisiopatología de NAFLD: Mecanismos moleculares, patogénesis e historia natural de NAFLD",
        from: "16:00",
        to: "16:30",
        duration: "30 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/maria-cristina-quintanilla-garcia/endocrinologo-internista/-https://www.doctoralia.com.mx/alexandro-atilano-diaz/gastroenterologo-endoscopista-internista/san-pedro-garza-garcia",
    },
  },
  {
    id: 14,
    ...
    congress: [
      {
        topic:
          "Relación entre NAFLD y enfermedades endócrinas: Diabetes mellitus, dislipidemia, enfermedad tiroidea, síndrome de ovario poliquístico y obesidad",
        from: "16:30",
        to: "17:00",
        duration: "30 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/maria-cristina-quintanilla-garcia/endocrinologo-internista/-",
    },
  },
  {
    id: 15,
    ...
    congress: [
      {
        topic:
          "Detección temprana, diagnóstico diferencial y herramientas no invasivas",
        from: "17:00",
        to: "17:30",
        duration: "30 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/omar-david-borjas-almaguer/gastroenterologo-internista-endoscopista/nuevo-leon",
    },
  },
  {
    id: 16,
    ...
    congress: [
      {
        topic:
          "Tratamiento de NAFLD: Impacto de cambios en estilo de vida y revisión de la evidencia e indicaciones de vitamina E, TZD, iSGLT2, GLP1a y metformina",
        from: "17:45",
        to: "18:15",
        duration: "30 min",
      },
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Beneficios, indicaciones y contraindicaciones de la cirugía bariátrica",
        from: "18:15",
        to: "18:45",
        duration: "30 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/carolina-castillo-castro/endocrinologo-internista/nuevo-leon",
    },
  },
  {
    id: 23,
    ...
    congress: [
      {
        topic:
          "Diabetes y Obesidad: abordaje e importancia del manejo aplicado a casos clínicos.",
        from: "16:45",
        to: "17:15",
        duration: "30 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/paola-portillo-sanchez/internista/monterrey",
    },
  },
  {
    id: 24,
    ...
    congress: [
      {
        topic:
          "Evaluación y tratamiento del riesgo residual de la enfermedad renal crónica en el paciente con Diabetes tipo 2. Casos clínicos.",
        from: "18:15",
        to: "18:45",
        duration: "30 min",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/juan-carlos-garnica-cuellar/endocrinologo/gustavo-a-madero",
    },
  },
  {
    id: 25,
    ...
    congress: [
      {
        topic:
          "Salud mental en el paciente con obesidad, puntos clave en la evaluación.",
        from: "",
        to: "",
        duration: "",
      },
    ...
    specialities: ["Obesidad"],
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/claudia-analy-velez-viveros/endocrinologo-internista/nuevo-laredo",
    },
  },
  {
    id: 26,
    ...
    congress: [
      {
        topic:
          "Obesidad e infertilidad femenina: mediadores potenciales del impacto de la obesidad.",
        from: "",
        to: "",
        duration: "",
      },
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/carolina-medrano-de-avila/endocrinologo/tijuana",
    },
  },
  {
    id: 27,
    ...
    congress: [
      {
        topic:
          "Detección oportuna de complicaciones, manejo multidisciplinario.",
        from: "",
        to: "",
        duration: "",
      },
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Tratamiento en obesidad: ¿Manejo farmacológico o cirugía bariátrica?",
        from: "",
        to: "",
        duration: "",
      },
    ...
    specialities: ["Obesidad", "Neuroendocrinología", "Diabetología"],
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/yunuhen-n-moreno-cuevas/endocrinologo/zacapu",
    },
  },
  {
    id: 29,
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/fernando-javier-lavalle-gonzalez/endocrinologo/monterrey",
    },
  },
  {
    id: 30,
  ...
  },
  {
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/sergio-zuniga-guajardo/endocrinologo-internista/monterrey",
    },
  },
  {
    id: 32,
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Nuevos objetivos de control en diabetes, variabilidad glucémica y tiempo en rango.",
        from: "10:35 am",
        to: "10:55 am",
        duration: "20 min",
      },
    ...
    address: {
      completeAddress:
        "San Jerónimo, Pte. 300, Miravalle, 64660 Monterrey, N.L",
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/maria-elena-romero-ibarguengoitia/endocrinologo-internista/nuevo-leon",
    },
  },
  {
    id: 34,
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/alfonso-javier-zapata-garrido/endocrinologo-internista/monterrey",
    },
  },
  {
    id: 35,
    ...
    address: {
      completeAddress:
        "Calz. San Pedro 255 Sur, Colonia del Valle, Del Valle, San Pedro Garza Garcia",
      suburb: "Colonia del Valle",
      state: "Nuevo León",
      town: "San Pedro Garza Garcia",
      zipcode: "",
    },
    specialities: ["Neuroendocrinología", "Adrenales"],
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/jose-miguel-hinojosa-amaya/endocrinologo/san-pedro-garza-garcia",
    },
  },
  {
    id: 36,
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Tratamiento y pautas para tratamiento nutricio en pacientes con diabetes mellitus e insuficiencia renal.",
        from: "8:10 am",
        to: "8:45 am",
        duration: "35 min",
      },
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Microbiotica y probioticos en el paciente con diabetes mellitus tipo 2.",
        from: "8:45 am",
        to: "9:20 am",
        duration: "35 min",
      },
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Alimentación funcional y su utilización en el tratamiento nutricio en personas con diabetes mellitus.",
        from: "9:20 am",
        to: "9:50 am",
        duration: "30 min",
      },
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Importancia de la suplementación posterior a la cirugía metabólica a corto y largo plazo.",
        from: "10:00 am",
        to: "10:35 am",
        duration: "35 min",
      },
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "Esteatosis hepatica: ¿Cuál es el papel que juega la nutrición en su tratamiento?",
        from: "11:10 am",
        to: "11:45 am",
        duration: "35 min",
      },
    ...
    address: {
      completeAddress:
        "I. Morones Prieto, Monterrey Hospital San José Tec de Monterrey",
      suburb: "",
      state: "",
      town: "",
      zipcode: "",
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/ana-sofia-guerra-cantu/nutriologo-clinico/monterrey",
    },
  },
  {
    id: 43,
    ...
    mainTopics: [
      {
        topic:
          "Nutrición, Endocrinología y Salud metabólica en condiciones médicas comunes.",
        moderator:
          "Dra. Elizabeth Solís Pérez NC y  ENC Ma. Alejandra Sánchez Peña NC.",
      },
    ],
    firstName: "Marisol",
    ...
    congress: [
      {
        topic:
          "Intervención Nutricional en enfermedad vascular  y su interacción con drogas (Pacientes que utilizan anticoagulantes).",
        from: "12:15",
        to: "12:35",
        duration: "20 min",
      },
    ...
    address: {
      completeAddress:
        "Francisco Garza Sada 2925, Chepevera, Monterrey Be Well Center",
      suburb: "",
      state: "",
      town: "",
      zipcode: "",
    ...
    socialMedia: {
      doctoralia:
        "https://www.doctoralia.com.mx/marisol-brito-alvarez/nutriologo-clinico/nuevo-leon",
    },
  },
  {
    id: 44,
  ...
  },
  {
    ...
    congress: [
      {
        topic:
          "¿Cálculos Renales? Como interviene la Nutrición para mejorar la salud metabólica.",
        from: "12:55",
        to: "13:15",
        duration: "20 min",
      },
